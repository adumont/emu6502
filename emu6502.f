...
DEFER INT_HANDLER ( -- f ) \ returns 0 if interrupt fired
...
: (INT_HANDLER) ( -- f ) \ returns 0 if interrupt fired
  NMI_LINE 0= IF          NMI_FIRED 0 EXIT THEN
  IRQ_LINE 0= IF I> 0= IF IRQ_FIRED 0 EXIT THEN THEN
  1 \ no interrupt fired
;
...
' NOP BIND{ $03 $0B $13 $1B $23 $2B $33 $3B $43 $4B $53 };
' NOP BIND{ $5B $63 $6B $73 $7B $83 $8B $93 $9B $A3 $AB };
' NOP BIND{ $B3 $BB $C2 $C3 $D3 $E2 $E3 $EB $F3 $FB };

\ advance PC by 1
:NONAME _PC @ 1+ _PC! ; BIND{ $02 $22 $42 $62 $82 $44 $54 $D4 $F4 };

\ advance PC by 2
:NONAME _PC @ 2+ _PC! ; BIND{ $DC $FC $5C };
